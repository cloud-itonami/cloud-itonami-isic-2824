...
`cloud-itonami-isic-2824` is an OSS open-business blueprint for mining,
quarrying and construction machinery manufacturing enablement, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Heavy Equipment Governor remains independent of the advisor.
