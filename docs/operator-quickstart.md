# Operator Quickstart — Manufacture of Machinery for Mining, Quarrying and Construction

Shortest path from clone to a verified local dry-run for **ISIC 2824** (`cloud-itonami-isic-2824`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2824.git
cd cloud-itonami-isic-2824
```
...
- Blueprint governor key: `heavyequip-governor`
- Likely source path: `heavyequip.governor.cljc`
